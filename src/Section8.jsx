...
import img1 from "../src/assets/section8img1.jpg";  
import img2 from "../src/assets/section8img2.jpg";  
import img3 from "../src/assets/section8img3.jpg";  
import img4 from "../src/assets/section8img4.png";  
function Section8(){
    return(
        <section className="bg-black lg:pt-40 pt-20 lg:h-200 h-130">
                   <div className="flex lg:flex-row flex-col gap-5 justify-center lg:px-10 px-2">
                       <div>
                           <img src={yacht} alt="" className="w-140 rounded-xl" />
                       </div>
